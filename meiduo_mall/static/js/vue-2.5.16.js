...
var config = ({
  /**
   * Option merge strategies (used in core/util.py/options)
   */
  // $flow-disable-line
...
// check platforms/web/util.py/attrs.js acceptValue
...
// install platform specific util.py
