...
class IntegralGoods(BaseModel):
    """统计分类商品访问量模型类"""
    sku = models.ForeignKey(SKU, on_delete=models.CASCADE, verbose_name='商品')
    integral = models.IntegerField(verbose_name='所需积分', default=0)
    new_price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='换购价')
